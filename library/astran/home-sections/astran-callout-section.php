                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-12 col-md-12 text-center">
                            ...
                            <div class="service-payment-btn">
                                <a href="<?php echo esc_url($callout_title_url); ?>" class="default-btn default-bg-black mr-3">
                                    <?php echo esc_html($callout_title_button);  ?>
                                </a>
                                <a href="<?php echo esc_url($callout_title_url_2); ?>" class="default-btn default-bg-black">
